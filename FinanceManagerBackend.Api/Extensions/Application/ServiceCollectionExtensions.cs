...
using FinanceManagerBackend.Api.Configurations.Swagger;
using FinanceManagerBackend.Api.Metrics;
using FinanceManagerBackend.Api.Redis;
using FinanceManagerBackend.Api.Services.Auth;
using FinanceManagerBackend.Core.Configurations;
using FinanceManagerBackend.Core.Model.Auth;
using FinanceManagerBackend.Core.Repositories;
using FinanceManagerBackend.Data;
using FinanceManagerBackend.Data.Repositories;
    ...
    private static void AddContext(this IServiceCollection services, string connectionString)
    {
        services.AddDbContext<ApplicationContext>(options =>
        {
            options.UseNpgsql(connectionString,
                b => { b.MigrationsAssembly("FinanceManagerBackend.Data"); });
        });
    }
